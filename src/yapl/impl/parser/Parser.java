...
public class Parser implements ParserConstants {
  ...
  static final public Type Literal() throws ParseException {
        Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TRUTHVALUE:
      t = jj_consume_token(TRUTHVALUE);
                       errorToken = t; {if (true) return new BoolType();}
      break;
    case number:
      t = jj_consume_token(number);
                   errorToken = t; {if (true) return new IntType();}
      break;
    default:
      jj_la1[0] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public TypeAndToken Selector(Type input) throws ParseException, YAPLException {
  Type type;
  Token t;
              ...
              tt = Selector(type);
                  if(!(sym.getType() instanceof ArrayType) || ((ArrayType)sym.getType()).getDim() <  1) {
                    if(!(sym.getType() instanceof RecordType)) {
                                {if (true) throw new YAPLException(20, null, tt.getToken());}
                        }
                  }
              break;
            default:
              ...
              ;
                ...
                {if (true) return tt != null ? tt.getType() : type;}
            break;
          default:
            jj_la1[5] = jj_gen;
            jj_consume_token(-1);
